...
Read-Host 'Run PowerShell as Admin! Press any for continue'

$pathExclusions.Add('C:\Windows\Microsoft.NET') > $null
$pathExclusions.Add('C:\Windows\assembly') > $null

$pathExclusions.Add($userPath + '\source') > $null
$pathExclusions.Add('C:\Git') > $null
$pathExclusions.Add('C:\Build') > $null
$pathExclusions.Add('C:\NuGetPackages') > $null
$pathExclusions.Add('P:\NuGetPackages') > $null
$pathExclusions.Add('C:\Program Files\DBeaver') > $null
...
$pathExclusions.Add('C:\Program Files (x86)\Microsoft SDKs') > $null
$pathExclusions.Add('C:\Program Files\Microsoft Visual Studio') > $null
$pathExclusions.Add('C:\Program Files\Microsoft Visual Studio 10.0') > $null


# POSTGRESQL
$pathExclusions.Add('C:\Program Files\PostgreSQL') > $null
$processExclusions.Add('postgresql.exe') > $null
$processExclusions.Add('postgres.exe') > $null
$processExclusions.Add('pg_ctl.exe') > $null
$processExclusions.Add('pg_dump.exe') > $null
$processExclusions.Add('psql.exe') > $null
$processExclusions.Add('pg_restore.exe') > $null

$processExclusions.Add('dbeaver.exe') > $null
